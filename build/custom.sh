...
sed -i '/ruby_edit "$CONFIG_FILE" "\[.dns.\]\[.proxy-server-nameserver.\]"/a\    ruby_edit "$CONFIG_FILE" "['\''dns'\''\]['\''proxy-server-nameserver'\'']" "['\''https://doh.pub/dns-query'\'','\''https://dns.alidns.com/dns-query'\'','\''https://223.5.5.5:443/dns-query'\'','\''https://dns.cloudflare.com/dns-query'\'','\''https://dns.google/dns-query'\'']"' package/dbone-package/luci-app-openclash/root/etc/openclash/custom/openclash_custom_overwrite.sh

# 写入自定义规则
cat >> package/dbone-package/luci-app-openclash/root/etc/openclash/custom/openclash_custom_rules.list <<EOF
